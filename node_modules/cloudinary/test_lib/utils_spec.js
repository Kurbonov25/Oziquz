(function() {
  var Q, TEST_TAG, api, clone, cloud_name, cloudinary, defaults, expect, fs, helper, http, isString, itBehavesLike, merge, only, os, root_path, sharedExamples, test_cloudinary_url, utils,
    slice = [].slice;
  ...
  clone = utils.clone, isString = utils.isString, merge = utils.merge, only = utils.only;
  ...
  describe("utils", function() {
    ...
    it("build_upload_params canonize booleans", function() {
      ...
      expected = only.apply(null, [params].concat(slice.call(Object.keys(options))));
      actual = {
        backup: 1,
        use_filename: 0,
        colors: 1,
    ...
    describe('Conditional Transformation', function() {
      ...
      describe('with tags', (function(_this) {
        return function() {
    ...
    return describe('User Define Variables', function() {
